...
#Select matches
cursor.execute('SELECT match_id FROM Match LIMIT 4000')
...
#Go through participants' data
	...
	total = {'blue':{'kills':0, 'deaths':0, 'assists':0,'gold_earned':0, 'magic_damage':0,
		'physical_damage':0, 'damage':0, 'damage_taken':0, 'crowd_control_dealt':0, 'wards_placed':0,
		'ward_kills':0}, 
	...
	for participant in participants:
		...
		tmp = {'side':side, 'champion':champion, 'kills':kills, 'deaths':deaths, 'assists':assists,
			...
			'damage':damage, 'damage_taken':damage_taken, 'crowd_control_dealt':crowd_control_dealt,
		...
		#Insert
			cursor.execute('INSERT INTO TotalChampionStats VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)',\
				(player['champion'],player['kills'],player['deaths'],player['assists'],player['gold_earned'],player['magic_damage'],\
					player['physical_damage'],player['damage'], player['damage_taken'],\
					...
					total['blue']['physical_damage'],total['blue']['damage'],total['blue']['damage_taken'],\
		...
		#Insert
			cursor.execute('INSERT INTO TotalChampionStats VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)',\
				(player['champion'],player['kills'],player['deaths'],player['assists'],player['gold_earned'],player['magic_damage'],\
					...
					total['red']['physical_damage'],total['red']['damage'],total['red']['damage_taken'],\
